...
import React2, { createContext, useContext, useRef, useState, useEffect, useCallback, useId, useMemo } from 'react';
import { usePathname } from 'next/navigation';
import { cva } from 'class-variance-authority';
import { Slot, Separator as Separator$1, Dialog } from 'radix-ui';
import { XIcon, CheckIcon, ArrowRightIcon, ArrowRight, Sparkles, FileText, BarChart3, Zap } from 'lucide-react';
...
function ThemeProvider({ children }) {
  return /* @__PURE__ */ jsx(ThemeProvider$1, { attribute: "class", defaultTheme: "light", enableSystem: false, children });
}
...
var AnimationContext = createContext(true);
...
function PageAnimationGate({ children }) {
  ...
  return /* @__PURE__ */ jsx(AnimationContext.Provider, { value: cache.current.value, children });
}
  ...
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-destructive text-white focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 [a&]:hover:bg-destructive/90",
    ...
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("span", { className: "relative flex h-1.5 w-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-[#FF602D] opacity-75" }),
          /* @__PURE__ */ jsx("span", { className: "relative inline-flex h-1.5 w-1.5 rounded-full bg-[#FF602D]" })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "text-[0.8125rem] font-semibold uppercase tracking-[0.14em] text-foreground dark:text-white/60", children })
      ]
    }
  );
}
...
var shimmerGradients = {
  ...
  orange: {
    background: "linear-gradient(105deg, transparent 40%, rgba(255,96,45,0.08) 48%, rgba(255,96,45,0.14) 50%, rgba(255,96,45,0.08) 52%, transparent 60%)"
  }
};
  ...
  return /* @__PURE__ */ jsxs(
    Comp,
    {
      ...
      className: cn(
        ...
        shimmerColor === "white" ? "bg-[#272727] text-white dark:bg-[#272727]" : "bg-white text-foreground border border-border dark:bg-white dark:text-[#272727]",
        className
      ),
      ...props,
      children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "relative z-10 inline-flex items-center gap-2", children })
      ]
    }
  );
}
function AnnouncementPill({
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      href,
      ...external ? { target: "_blank", rel: "noopener noreferrer" } : void 0,
      className: cn(
      ...
      style: { boxShadow: "0 2px 12px rgba(0,0,0,0.04)" },
      children: [
        /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2 text-sm font-medium text-foreground dark:text-white/90", children: [
          /* @__PURE__ */ jsxs("span", { className: "relative flex h-1.5 w-1.5", children: [
            /* @__PURE__ */ jsx("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-500 opacity-75" }),
            /* @__PURE__ */ jsx("span", { className: "relative inline-flex h-1.5 w-1.5 rounded-full bg-emerald-500" })
          ] }),
          children
        ] }),
        /* @__PURE__ */ jsx("span", { className: "block h-4 w-px bg-border/60 dark:bg-white/[0.1]" }),
        /* @__PURE__ */ jsx("span", { className: "flex h-6 w-6 items-center justify-center rounded-full bg-secondary transition-colors duration-200 group-hover:bg-secondary/80 dark:bg-white/[0.06] dark:group-hover:bg-white/[0.1]", children: /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3 text-foreground/60 dark:text-white/40" }) })
      ]
    }
  );
}
...
var FlipWords = ({
  ...
  return /* @__PURE__ */ jsx("span", { className: "inline-block relative", children: /* @__PURE__ */ jsx(
    AnimatePresence,
    {
      onExitComplete: () => {
      ...
      children: /* @__PURE__ */ jsx(
        motion.span,
        {
          ...
          children: isMobile ? /* @__PURE__ */ jsx("span", { className: "whitespace-nowrap", children: currentWord }) : currentWord.split(" ").map((word, wordIndex) => /* @__PURE__ */ jsxs(
            motion.span,
            {
              ...
              children: [
                word.split("").map((letter, letterIndex) => /* @__PURE__ */ jsx(
                  motion.span,
                  {
                    initial: { opacity: 0, y: 10, filter: "blur(8px)" },
                    animate: { opacity: 1, y: 0, filter: "blur(0px)" },
                ...
                /* @__PURE__ */ jsx("span", { className: "inline-block", children: "\xA0" })
              ]
            },
            word + wordIndex
          ))
...
function AnimatedGroup({
  ...
  return /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      children: React2.Children.map(children, (child, index) => /* @__PURE__ */ jsx(motion.div, { variants: itemVariants, children: child }, index))
    }
  );
}
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("svg", { x, y, className: "overflow-visible", children: squares.map(({ pos: [x2, y2], id: id2 }, index) => /* @__PURE__ */ jsx(
          motion.rect,
          {
            initial: { opacity: 0 },
...
function TextEffect({
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", children: trigger && /* @__PURE__ */ jsx(
    MotionTag,
    {
      initial: "hidden",
      animate: "visible",
...
function NoiseTexture() {
  return /* @__PURE__ */ jsxs("svg", { className: "noise-overlay", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx("filter", { id: "noise", children: /* @__PURE__ */ jsx(
      "feTurbulence",
      {
        type: "fractalNoise",
        baseFrequency: "0.8",
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        children && /* @__PURE__ */ jsx("div", { className: "relative z-10 w-full h-full flex items-center justify-center px-4", children })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent transition-colors duration-300 group-hover/card:from-black/60", children: /* @__PURE__ */ jsxs("div", { className: "flex items-end justify-between px-6 py-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col transition-transform duration-300 group-hover/card:-translate-y-0.5", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold text-white transition-all duration-300 group-hover/card:text-xl", children: title }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-white/90 transition-colors duration-300 group-hover/card:text-white", children: subtitle })
          ] }),
          /* @__PURE__ */ jsx(
            Wrapper,
            {
              ...
              children: /* @__PURE__ */ jsx(ArrowRight, { className: "h-5 w-5 text-gray-800 transition-colors duration-300 group-hover/card:text-[#FF602D]" })
            }
          )
        ] }) })
      ]
...
var AvatarCircles = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("z-10 flex -space-x-4 rtl:space-x-reverse", className), children: [
    avatarUrls.map((url, index) => /* @__PURE__ */ jsx(
      "img",
      {
    ...
    numPeople && /* @__PURE__ */ jsxs("span", { className: "flex h-10 w-10 items-center justify-center rounded-full border-2 border-white bg-[#272727] text-center text-xs font-medium text-white dark:border-gray-800 dark:bg-white dark:text-[#272727]", children: [
      "+",
      numPeople
    ] })
  ] });
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: cn("text-base font-semibold", titleClassName), children: title })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed text-foreground/80 dark:text-white/70", children: description }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground dark:text-white/30", children: date })
      ]
    }
  );
}
function DisplayCards({ cards }) {
  const defaultCards = [
    ...
    {
      icon: /* @__PURE__ */ jsx(BarChart3, { className: "size-4" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative h-[500px] w-full", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "relative", style: { width: "420px", height: "400px" }, children: displayCards.map((cardProps, index) => /* @__PURE__ */ jsx(
            "div",
            {
              className: "absolute left-0 top-0",
              style: { zIndex: index },
              children: /* @__PURE__ */ jsx(DisplayCard, { ...cardProps })
            },
            index
          )) }) })
        ]
    ...
    /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-background to-transparent" })
  ] });
}
function FloatingLogos({ logos, className }) {
  const defaultLogos = [
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "S", color: "#4A90D9" }), size: 52, top: "12%", left: "8%", rotate: -15, delay: 0, zIndex: 2 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "G", color: "#34A853" }), size: 44, top: "28%", left: "42%", rotate: 12, delay: 0.3, zIndex: 3 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "X", color: "#1D6F42" }), size: 38, top: "18%", left: "26%", rotate: -8, delay: 0.6, zIndex: 1 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "N", color: "#E01E5A" }), size: 48, top: "5%", left: "55%", rotate: 20, delay: 0.15, zIndex: 2 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "Q", color: "#FF602D" }), size: 56, top: "45%", left: "5%", rotate: -22, delay: 0.45, zIndex: 4 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "Z", color: "#6366F1" }), size: 40, top: "55%", left: "35%", rotate: 8, delay: 0.75, zIndex: 1 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "D", color: "#0EA5E9" }), size: 46, top: "65%", left: "18%", rotate: -12, delay: 0.9, zIndex: 3 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "A", color: "#F59E0B" }), size: 36, top: "38%", left: "52%", rotate: 25, delay: 0.2, zIndex: 2 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "P", color: "#EF4444" }), size: 42, top: "75%", left: "45%", rotate: -18, delay: 0.55, zIndex: 1 },
    { icon: /* @__PURE__ */ jsx(PlaceholderIcon, { label: "R", color: "#8B5CF6" }), size: 50, top: "82%", left: "8%", rotate: 15, delay: 0.35, zIndex: 2 }
  ];
  const items = logos || defaultLogos;
  return /* @__PURE__ */ jsx("div", { className: cn("relative h-full w-full", className), children: items.map((logo, i) => /* @__PURE__ */ jsx(
    motion.div,
    {
      className: "absolute",
      style: {
...
function PlaceholderIcon({ label, color }) {
  return /* @__PURE__ */ jsx("span", { className: "select-none text-sm font-bold", style: { color }, children: label });
}

export { AnimatedGridPattern, AnimatedGroup, AnnouncementPill, AuroraBackground, AvatarCircles, Badge, Button, Card, CardAction, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, DisplayCard, DisplayCards, FlickeringGrid, FlipText, FlipWords, FloatingLogos, GradientBars, GradientBarsBackground, Highlight, Input, Label, MultiStepForm, NoiseTexture, PageAnimationGate, ProgressiveBlurCard, ScrollProgress, SectionPill, Separator, Sheet, SheetClose, SheetContent, SheetDescription, SheetFooter, SheetHeader, SheetTitle, SheetTrigger, ShimmerButton, Spotlight, TextEffect, ThemeProvider, badgeVariants, buttonVariants, cn, fadeUp, shouldAnimatePage, stagger, usePageAnimation };
