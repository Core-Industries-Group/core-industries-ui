...
function ThemeToggle() {
  ...
  if (!mounted) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-10 w-[4.5rem]" });
  }
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex w-full items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: isDark ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Moon, { className: "h-4 w-4 text-white", strokeWidth: 2 }) : /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Sun, { className: "h-4 w-4 text-white", strokeWidth: 2 })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: isDark ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Sun, { className: "h-4 w-4 text-white/40", strokeWidth: 2 }) : /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Moon, { className: "h-4 w-4 text-[#272727]/60", strokeWidth: 2 })
          }
        )
      ] })
    }
...
function BackToTop() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: visible && /* @__PURE__ */ jsxRuntime.jsx(
    framerMotion.motion.button,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowUp, { className: "h-4 w-4 text-foreground/70 dark:text-white/60", strokeWidth: 2 })
    }
  ) });
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      framerMotion.motion.header,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs("nav", { className: "flex h-14 w-full items-center justify-between px-6 transition-all duration-500 ease-out md:h-12 md:pl-5 md:pr-1.5", children: [
          /* @__PURE__ */ jsxRuntime.jsxs(Link__default.default, { href: logoHref, className: "relative z-10 shrink-0", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "hidden items-center gap-1 md:flex", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntime.jsx(
            NavLink,
            {
              href: link.href,
              label: link.label,
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "hidden items-center gap-2 md:flex", children: /* @__PURE__ */ jsxRuntime.jsxs(
            Link__default.default,
            {
              href: ctaHref,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(FlipText, { children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "relative z-10", children: ctaLabel }) }),
                /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { className: "relative z-10 h-3.5 w-3.5 transition-transform duration-200 group-hover:translate-x-0.5" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex h-4 w-5 flex-col items-center justify-center", children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  framerMotion.motion.span,
                  {
    ...
    /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntime.jsx(
      framerMotion.motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col p-4", children: [
          /* @__PURE__ */ jsxRuntime.jsx("nav", { className: "grid gap-y-0.5", children: navLinks.map((link, i) => /* @__PURE__ */ jsxRuntime.jsx(
            framerMotion.motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs(
                Link__default.default,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "relative z-10", children: ctaLabel })
                  ]
                }
              )
            }
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fixed bottom-6 right-6 z-50", children: /* @__PURE__ */ jsxRuntime.jsx(ThemeToggle, {}) }),
    /* @__PURE__ */ jsxRuntime.jsx(BackToTop, {})
  ] });
}
...
function FooterContent({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative flex w-full flex-col border-t border-white/10 bg-[#272727] text-white px-5 pt-6 pb-14 md:px-12 md:pt-8 md:pb-14", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative z-10 mx-auto w-full max-w-7xl mt-2 md:mt-4", children: /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(AnimatedContainer, { delay: 0.1, children: [
            /* @__PURE__ */ jsxRuntime.jsx(Image__default.default, { src: logoSrc, alt: logoAlt, width: logoWidth, height: logoHeight }),
            tagline && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-3 text-sm leading-relaxed text-white/60", children: tagline })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-6 lg:contents", children: [
            navLinks.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs(AnimatedContainer, { delay: 0.2, className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "mb-3 font-display text-base font-semibold md:mb-4 md:text-lg", children: "Navigation" }),
              /* @__PURE__ */ jsxRuntime.jsx("nav", { className: "space-y-2 text-sm", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntime.jsx(
                Link__default.default,
                {
                  href: link.href,
            ...
            (email || phone || location) && /* @__PURE__ */ jsxRuntime.jsxs(AnimatedContainer, { delay: 0.3, className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "mb-3 font-display text-base font-semibold md:mb-4 md:text-lg", children: "Contact Us" }),
              /* @__PURE__ */ jsxRuntime.jsxs("address", { className: "space-y-2 text-sm not-italic text-white/60", children: [
                ...
                phone && /* @__PURE__ */ jsxRuntime.jsx("p", { children: /* @__PURE__ */ jsxRuntime.jsx(
                  "a",
                  {
                ...
                location && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-white/60", children: location })
              ] })
            ] })
          ] }),
          showNewsletter && /* @__PURE__ */ jsxRuntime.jsxs(AnimatedContainer, { delay: 0.4, className: "relative", children: [
            /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "mb-2 font-display text-base font-semibold md:text-lg", children: newsletterHeading }),
            newsletterSubtext && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mb-4 text-sm text-white/60 md:mb-5", children: newsletterSubtext }),
            /* @__PURE__ */ jsxRuntime.jsxs("form", { className: "space-y-3", onSubmit: handleSubmit, children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "relative z-10", children: /* @__PURE__ */ jsxRuntime.jsx(FlipText, { children: newsletterButtonLabel }) })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pointer-events-none absolute -right-4 top-0 h-24 w-24 rounded-full bg-primary/10 blur-2xl" })
          ] })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative z-10 mx-auto w-full max-w-7xl mt-4 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-4 text-center md:mt-6 md:flex-row md:gap-4 md:pt-6", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-sm text-white/40", children: [
        "\xA9 ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        copyrightText ? ` ${copyrightText}` : ""
      ] }),
      legalLinks.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("nav", { className: "flex gap-4 text-sm", children: legalLinks.map((link) => /* @__PURE__ */ jsxRuntime.jsx(
        Link__default.default,
        {
          href: link.href,
...
function MarketingFooter(props) {
  ...
  if (!isDesktop) {
    return /* @__PURE__ */ jsxRuntime.jsx("footer", { className: "relative w-full bg-[#272727]", children: /* @__PURE__ */ jsxRuntime.jsx(FooterContent, { ...props }) });
  }
  return /* @__PURE__ */ jsxRuntime.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fixed bottom-0 w-full", children: /* @__PURE__ */ jsxRuntime.jsx("div", { ref: contentRef, children: /* @__PURE__ */ jsxRuntime.jsx(FooterContent, { ...props }) }) })
    }
  );
}
  ...
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-full text-sm font-medium whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-destructive text-white hover:bg-destructive-hover focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
...
function MultiStepForm({ variant = "default" }) {
  ...
  if (isComplete) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-full max-w-sm", children: /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          !isAccented && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(120,119,198,0.1),transparent_50%)]" }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mb-10 flex items-center", children: steps.map((step, index) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("flex items-center", index < steps.length - 1 && "flex-1"), children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
          ...
          index < steps.length - 1 && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative h-[1.5px] flex-1 mx-3", children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                className: cn(
...
function CTASection({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs("section", { className: "relative overflow-hidden py-10 md:py-14", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          className: "absolute inset-0",
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative mx-auto max-w-3xl px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntime.jsxs(
        framerMotion.motion.div,
        {
          initial: "hidden",
          whileInView: "visible",
          ...
          children: [
            ...
            variant === "modal" ? /* @__PURE__ */ jsxRuntime.jsx(framerMotion.motion.div, { variants: fadeUp, custom: 0.16, className: "mt-10", children: /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "relative z-10 flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntime.jsx(FlipText, { children: modalTriggerLabel }),
                    /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { className: "h-4 w-4 transition-transform duration-200 group-hover:translate-x-0.5" })
                  ] })
                ]
              }
            ) }) : /* @__PURE__ */ jsxRuntime.jsxs(
              framerMotion.motion.div,
              {
                ...
                children: [
                  primaryCTA && (primaryCTA.external ? /* @__PURE__ */ jsxRuntime.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "relative z-10", children: /* @__PURE__ */ jsxRuntime.jsx(FlipText, { children: primaryCTA.label }) })
                      ]
                    }
                  ) : /* @__PURE__ */ jsxRuntime.jsxs(
                    Link__default.default,
                  ...
                  secondaryCTA && (secondaryCTA.external ? /* @__PURE__ */ jsxRuntime.jsx(
                    "a",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntime.jsx(FlipText, { children: secondaryCTA.label })
                    }
                  ) : /* @__PURE__ */ jsxRuntime.jsx(
                    Link__default.default,
                    {
    ...
    variant === "modal" && /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: isModalOpen && /* @__PURE__ */ jsxRuntime.jsxs(
      framerMotion.motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 bg-black/60 backdrop-blur-md" }),
          /* @__PURE__ */ jsxRuntime.jsxs(
            framerMotion.motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mb-6", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "font-display text-xl font-bold text-gray-900", children: "Let's start a conversation" }),
                  /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-1 text-sm text-gray-500", children: "Tell us a little about yourself." })
                ] }),
                /* @__PURE__ */ jsxRuntime.jsx(MultiStepForm, { variant: "modal" })
              ]
            }
          )
        ]
...
function LegalHero({ title, numBars = 7 }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative -mt-14", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pointer-events-none absolute inset-x-0 top-0 h-[44vh]", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        GradientBars,
        {
          numBars,
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative z-[3] mx-auto max-w-4xl px-6 pt-32 pb-8 text-center md:pt-36 md:pb-10", children: /* @__PURE__ */ jsxRuntime.jsx("h1", { className: "font-display text-4xl font-extrabold tracking-tight text-foreground md:text-5xl lg:text-6xl", children: title }) })
  ] });
}

exports.CTASection = CTASection;
exports.LegalHero = LegalHero;
